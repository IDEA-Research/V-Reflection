...
def main():
    ...
    if len(sys.argv) > 1:
        ...
        # 默认使用当前打开的文件路径
        json_file_path = "/comp_robot/zhoujiazhou/projects/Active-Coconut/evaluation/results/blink/decoding_by_steps/7b_Stage1_steps2500_b1_mseLVR0.1/_comp_robot_zhoujiazhou_projects_Active-Coconut_result_stage1_checkpoints_7b_Stage1_steps2500_b1_mseLVR0.1-MaxVisToken5120-MinVisToken128_checkpoint-2100/steps004.json"

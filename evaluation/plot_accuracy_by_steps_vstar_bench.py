...
计算accuracy并绘制accuracy随训练step变化的图表 (vstar_bench数据集)
"""
...
def plot_accuracy(steps: List[int], accuracies: List[float], experiment_name: str, output_file: str, baseline_accuracy: float = None):
    ...
    plt.title(f'Accuracy vs Training Step: {experiment_name} (vstar_bench)', fontsize=14, fontweight='bold')
...
def main():
    ...
    """
    # 基础目录
    base_dir = "/comp_robot/zhoujiazhou/projects/Active-Coconut/evaluation/results/vstar_bench/decoding_by_steps"
    ...
    # 输出目录
    output_dir = "/comp_robot/zhoujiazhou/projects/Active-Coconut/evaluation/results/vstar_bench/accuracy_plots"

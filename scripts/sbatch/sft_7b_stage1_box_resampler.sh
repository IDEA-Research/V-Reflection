...
#SBATCH --output=logs/SFT_7b_box_resampler_b4_latent8_lr1e6_%j.txt
...
# CHECKPOINT_PATH=\"result/box_resampler/SFT_box_resampler_steps2500_b4_resampler0.1_acc8_latent8/checkpoint-1800\" sbatch scripts/sbatch/sft_7b_stage1_box_resampler.sh

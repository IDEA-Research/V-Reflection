...
#SBATCH --output=/comp_robot/zhoujiazhou/projects/Active-Coconut/logs/evaluation/lvr_stage1_7b_step4_%j.txt

# ============================================================================
# Evaluation Script for LVR Model (7B)
# ============================================================================
...
# After evaluation completes, it automatically calculates accuracy by category.
#
# Usage:
#   bash scripts/evaluation/evaluation_7b_sbatch.sh
#   Or called from training script with CHECKPOINT_PATH and EVAL_STEP_LIST env vars
# ============================================================================

# ============================================================================
# Configuration - Model Settings
# ============================================================================
# Model checkpoint path - Can be set via environment variable CHECKPOINT_PATH
CHECKPOINT_PATH="${CHECKPOINT_PATH:-/comp_robot/zhoujiazhou/projects/Active-Coconut/stage1_checkpoints/checkpoint-1000}"

...
# Requires Stage 1 checkpoint with use_box_feature_resampler (e.g. sft_7b_stage1 output).
# Usage: export CHECKPOINT_PATH="path/to/stage1_checkpoint"; bash scripts_release/train/sft_7b_stage2_distillation.sh
...
bash "$PROJECT_ROOT/scripts_release/evaluation/evaluation_7b_stage2.sh"
EVAL_EXIT=$?
